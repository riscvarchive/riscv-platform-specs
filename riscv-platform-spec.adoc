...
=== Base
==== ISA Requirements
The OS-A platform must comply with the RVA22U, RVA22S and RVA22M profiles
defined by the RISC-V profiles specification <<spec_profiles>> with the
...
* hstatus
** VTW bit must not be hardwired t0 0
...
categories of interrupt support and timer support allowed in a OS-A platorm.
...
* PMP/ePMP
** Minimum of 16 PMP regions support
